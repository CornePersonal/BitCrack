...
KeyFinder::KeyFinder(const secp256k1::uint256 &startKey, const secp256k1::uint256 &endKey, int compression, KeySearchDevice* device, const secp256k1::uint256 &stride, bool trueRandom)
{
	_total = 0;
...
void KeyFinder::init()
{
    ...
    _device->init(_startKey, _compression, _stride, _trueRandom);
}
